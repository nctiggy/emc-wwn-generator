...
//  /**
//  * Checks to see if user typed any characters other than digits.
//  * Returns true if key press is allowed.  False otherwise.
//  */
...
//  test: function(serialNumber) {
//    if (serialNumber.length == 9) {
//      return validateSerialNumber(serialNumber);
//    }
//  },

//  displaySymmWWNs: function(newDisplayList) {
//    try {
//      resultTable.fnClearTable();
//      resultTable.fnAddData(newDisplayList);
//
//      var resultDiv = $('#symmetrix-result');
//      if (!resultDiv.is(':visible')) {
//        resultDiv.show();
//        resultDiv.addClass('showing');
//        $('#symmTable').wrap('<div id="symmetrix-scroll" class="scroll-wrap"></div>');
//        $('#symmetrix-scroll').before('<div class="clearfix"></div>');
//      }
//      exporter.setContext('#symmetrix');
...
//
//
//        var symFilterInput = $("#symmTable .filter input");
//
//        symFilterInput.keyup(function () {
//            /* Filter on the column (the index) of this element */
//            oTable.fnFilter(this.value, symFilterInput.index(this));
//        });
//        var asInitVals = new Array();
//
//        symFilterInput.each(function (i) {
//            asInitVals[i] = this.value;
//        });
//
//        symFilterInput.focus(function () {
...
//        });
//
//        symFilterInput.blur(function (i) {
//            if (this.value == "") {
//                this.className = "search_init";
//                this.value = asInitVals[symFilterInput.index(this)];
//            }
//        });
//
//        symmVars.symmEncodeButton.click(function () {
//            calculateWwpns();
//        });
//
//        symmVars.serialNumberText.keydown(function() {
//            notifier.hideMessage();
//        });
//
//        symmVars.serialNumberText.keypress(function (event) {
//            return blockNonNumbers(symmVars.serialNumberText, event);
//        });
//
//        //extractNumber is in input-helper.js
//        symmVars.serialNumberText.keyup(function () {
//            test(symmVars.serialNumberText.val());
//        });
//    }
//
//    /* Public */
//
//
//      var serialNumber = "195701306";
//
//        // If the length of the serial number is greater than 9, truncate leading 0s
//        if (serialNumber.length > 9) {
...
//        var portList = createPortsList(serialNumber);
//        var displayList = getDisplayWWNs(serialNumber, portList);//?
